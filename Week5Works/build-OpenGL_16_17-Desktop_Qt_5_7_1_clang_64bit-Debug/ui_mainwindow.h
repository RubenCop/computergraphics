...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        resetRotationButton = new QPushButton(settingsBox);
        resetRotationButton->setObjectName(QStringLiteral("resetRotationButton"));

        formLayout->setWidget(7, QFormLayout::LabelRole, resetRotationButton);

        resetCameraButton = new QPushButton(settingsBox);
        resetCameraButton->setObjectName(QStringLiteral("resetCameraButton"));

        formLayout->setWidget(8, QFormLayout::LabelRole, resetCameraButton);

        resetScaleButton = new QPushButton(settingsBox);
        resetScaleButton->setObjectName(QStringLiteral("resetScaleButton"));

        formLayout->setWidget(9, QFormLayout::LabelRole, resetScaleButton);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        resetCameraButton->setText(QApplication::translate("MainWindow", "Reset Camera", Q_NULLPTR));
        resetScaleButton->setText(QApplication::translate("MainWindow", "Reset Scale", Q_NULLPTR));
    } // retranslateUi
